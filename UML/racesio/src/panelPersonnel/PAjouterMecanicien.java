...
//Panel
public class PAjouterMecanicien extends JPanel {
	...
	private JLabel lblAjouterMecanicien;
	...
	private JLabel lblDateQualification;
	private JLabel lblAQualification;
	...
	public PAjouterMecanicien() {
		...
		lblAjouterMecanicien = new JLabel("Ajouter un mécanicien");
		lblAjouterMecanicien.setForeground(Color.LIGHT_GRAY);
		lblAjouterMecanicien.setFont(new Font("Dialog", Font.BOLD, 16));
		GridBagConstraints gbc_lblAjouterMecanicien = new GridBagConstraints();
		gbc_lblAjouterMecanicien.insets = new Insets(0, 0, 5, 0);
		gbc_lblAjouterMecanicien.gridx = 0;
		gbc_lblAjouterMecanicien.gridy = 0;
		panel_menu.add(lblAjouterMecanicien, gbc_lblAjouterMecanicien);
		...
		//Panneau central au centre du panneau principal
				...
				lblAQualification = new JLabel("Qualification");
				lblAQualification.setFont(new Font("Dialog", Font.PLAIN, 13));
				GridBagConstraints gbc_lblAQualification = new GridBagConstraints();
				gbc_lblAQualification.anchor = GridBagConstraints.EAST;
				gbc_lblAQualification.insets = new Insets(0, 0, 5, 5);
				gbc_lblAQualification.gridx = 0;
				gbc_lblAQualification.gridy = 2;
				panel_identite.add(lblAQualification, gbc_lblAQualification);
				
				textFieldQualification = new JTextField();
				GridBagConstraints gbc_textFieldQualification = new GridBagConstraints();
				gbc_textFieldQualification.insets = new Insets(0, 0, 5, 5);
				gbc_textFieldQualification.fill = GridBagConstraints.HORIZONTAL;
				gbc_textFieldQualification.gridx = 1;
				gbc_textFieldQualification.gridy = 2;
				panel_identite.add(textFieldQualification, gbc_textFieldQualification);
				textFieldQualification.setColumns(10);
				
				lblDateQualification = new JLabel("Date");
				lblDateQualification.setFont(new Font("Dialog", Font.PLAIN, 13));
				GridBagConstraints gbc_lblDateQualification = new GridBagConstraints();
				gbc_lblDateQualification.insets = new Insets(0, 0, 5, 5);
				gbc_lblDateQualification.anchor = GridBagConstraints.WEST;
				gbc_lblDateQualification.gridx = 2;
				gbc_lblDateQualification.gridy = 2;
				panel_identite.add(lblDateQualification, gbc_lblDateQualification);
				...
				panel_identite.add(textFieldDate, gbc_textFieldDate);
