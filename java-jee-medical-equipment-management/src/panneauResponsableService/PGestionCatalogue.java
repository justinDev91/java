...
public class PGestionCatalogue extends JPanel {
	...
	public PGestionCatalogue() {
		...
		JComboBox comboBoxSupp_catalogue = new JComboBox();
		comboBoxSupp_catalogue.setBounds(157, 159, 247, 22);
		add(comboBoxSupp_catalogue);
		
		JLabel lblSupprimerUnCatalogue = new JLabel("Supprimer un catalogue");
		lblSupprimerUnCatalogue.setForeground(Color.WHITE);
		lblSupprimerUnCatalogue.setFont(new Font("Roboto", Font.PLAIN, 12));
		lblSupprimerUnCatalogue.setBounds(23, 154, 145, 27);
		add(lblSupprimerUnCatalogue);
		...
		panel_formulaire.setBounds(10, 67, 456, 71);
